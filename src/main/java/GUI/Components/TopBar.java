...
public class TopBar {
    ...
    public VBox getTopBar(Stage stage) {
        ...
        Image homeImage = new Image(getClass().getResourceAsStream("/Images/Icons/clients.png"), 32, 32, false, true);
        ...
        label.setStyle("-fx-font-family: \"Roboto\"");
        Image buildImg = new Image(getClass().getResourceAsStream("/Images/Icons/build.png"), 32, 32, false, true);
        ...
        label.setStyle("-fx-font-family: \"Roboto\"");
        Image settingsImg = new Image(getClass().getResourceAsStream("/Images/Icons/settings.png"), 32, 32, false, true);
        ...
        label.setStyle("-fx-font-family: \"Roboto\"");
        Image infoImg = new Image(getClass().getResourceAsStream("/Images/Icons/info.png"), 32, 32, false, true);
